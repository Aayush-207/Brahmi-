...
export default function DharmastalPage() {
    return (
        <main className="min-h-screen bg-linear-to-b from-[#0f0f0f] to-[#141212] text-[#E6D8B8] py-8 sm:py-12 lg:py-16">
            <div className="container mx-auto px-4 sm:px-6">
                <div className="max-w-4xl mx-auto bg-linear-to-br from-[#1a1613]/60 to-[#2a2420]/60 p-5 sm:p-8 lg:p-10 rounded-2xl sm:rounded-3xl shadow-2xl border border-[#E6D8B8]/10">
                    <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-5">
                        <div className="relative shrink-0 w-16 h-16 sm:w-20 sm:h-20 mx-auto sm:mx-0">
                            <Image src="/assets/jain_foundation_logo.jpg" alt="logo" fill className="object-contain rounded" />
                        </div>
                        <div className="text-center sm:text-left w-full">
                            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-serif text-[#E6B116] font-bold leading-tight">धर्मस्थल का सहयोग</h1>
                            <p className="mt-2 text-sm sm:text-base text-[#B8AFA0] leading-relaxed">धर्मस्थल संस्थान — ब्राह्मी लिपि संरक्षण एवं संवर्धन में अभिनन्दनीय सहयोग</p>
                        </div>
                    </div>

                    <article className="mt-6 sm:mt-8 text-[#E6D8B8]">
                        <div className="space-y-4 text-[15px] sm:text-base lg:text-lg leading-7 sm:leading-8">
                            ...
                            <div className="rounded-2xl border border-[#E6D8B8]/10 bg-[#1a1613]/70 p-4 sm:p-5">
                                <p className="text-[#E6B116] leading-relaxed">
                                    ब्राह्मी लिपि प्रचारक, <strong>श्रुताराधक सन्त क्षुल्लक श्री प्रज्ञांशसागर जी गुरुदेव</strong> की मंगल प्रेरणा एवं आध्यात्मिक मार्गदर्शन से संचालित ब्राह्मी लिपि पुनर्जागरण एवं संरक्षण-अभियान में धर्माधिकारी <strong>डॉ. डी. वीरेन्द्र हेगड़े जी तथा श्रद्धेया हेमवती हेगड़े</strong> जी द्वारा प्रदत्त सहयोग अत्यन्त प्रशन्सनीय एवं प्रेरणास्पद है।
                                </p>
                            </div>
                        ...
                        <div className="mt-8 sm:mt-10 flex justify-center sm:justify-start">
                            <Link
                                ...
                                className="inline-flex items-center justify-center w-8 h-8 sm:w-10 sm:h-10 rounded-full bg-[#292929] text-[#c09a05] hover:bg-transparent hover:text-[#E6D8B8] transition-colors duration-200"
                            >
